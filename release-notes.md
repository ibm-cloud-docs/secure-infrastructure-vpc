...
### 14 August 2026
{: #secure-infrastructure-vpc-aug-1426}
{: release-note}
...
:   New versions of the Cloud foundation for VPC deployable architectures are released in the {{site.data.keyword.cloud_notm}} [catalog](/catalog#deployable_architecture){: external}.
    ...
    - Version `10.0.0` of the `Standard - Integrated setup with configurable services` variation is available.
      - Removed all references to `Hyper Protect Crypto Services` (HPCS / hs-crypto) from the Deployable Architecture (DA). [Learn More](https://github.com/terraform-ibm-modules/terraform-ibm-landing-zone-vpc/releases/tag/v10.0.0#migration-guide)
